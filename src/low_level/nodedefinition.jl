...
function get_matrix( nodedef::NodeDefinition )
	ptr = ccall( (:nodedef_GetMatrix, "libsmilejl"), Ptr{Void}, (Ptr{Void},), nodedef.ptr )
	return DMatrix(ptr)
end

function set_definition( nodedef::NodeDefinition, dblarr::DoubleArray )

	err_int = ccall( (:nodedef_SetDefinition, "libsmilejl"), Int32, (Ptr{Void},Ptr{Void}), nodedef.ptr, dblarr.ptr )
	if err_int < 0
...
function set_number_of_outcomes( nodedef::NodeDefinition, idarr::IdArray )
	...
	err_int = ccall( (:nodedef_SetNumberOfOutcomes, "libsmilejl"), Int32, (Ptr{Void},Ptr{Void}), nodedef.ptr, idarr.ptr )
	if err_int < 0
